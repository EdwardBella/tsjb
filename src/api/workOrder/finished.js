...
// 修改结案状态
export const modifyFinishStatus = data => axios({
...
// 回访核实
export const addFllowUp = data => axios({
	url: '/api/v1/workOrderCheckVisit/add',
	method: 'POST',
	data
})
// 回退案件(针对调查中的案件)
...
export const list = params => axios({
	url: '/api/v1/workOrder/finish/list',
	method: 'GET',
	params
})
// 开始处理案件(针对调查中的案件)
...
/* 发起督办 */
export const addSuperviseHandle = (data) => axios({
	url: 'api/v1/workOrder/supervision/addSuperviseHandle',
	method: 'POST',
	data
})

/* 获取督办信息 */
export const getSuperviseStatus = (data) => axios({
	url: 'api/v1/workOrder/supervision/getSuperviseStatus',
	method: 'POST',
	data
})

/* 解除督办 */
export const cancelSuperviseHandle = (data) => axios({
	url: 'api/v1/workOrder/supervision/cancelSuperviseHandle',
	method: 'POST',
	data
})