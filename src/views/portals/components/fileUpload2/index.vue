<template>
	<div style="display: flex; align-items: center;">
		...
		<p style="font-size: 14px;line-height: 20px;margin-left: 8px;"><span
			...
			<span
				style="font-size: 16px;color: #1b5284;border: 1px solid #1b5284;border-radius: 4px;padding: 2px 6px;font-weight: bold;cursor: pointer;" @click="handleDownload">申请复核审批单</span>模板
		</p>
	</div>
</template>
