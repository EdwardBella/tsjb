	...
	<div class="dbContent">
		...
		<div>
			...
			<div class="buttons-cn">
				<el-button v-if="userRoles.isLeaderDepartment" icon="el-icon-plus"
					style="background: #1b5284;height: 40px;" type="primary"
					@click="handleShowAddWorkOrderDialog">创建案件</el-button>
		...
		<!-- 创建案件-->
		<createWorkOrderDialog v-if="createWorkOrderDialog.visible" :visible.sync="createWorkOrderDialog.visible"
			@success="handleAddWorkOrderSuccess">
	...
	export default {
		...
		methods: {
			...
			resetQuery() {
				...
				this.queryParams.status = '0,21,2,1,9,16,10,13'
			...
			handleShowAddWorkOrderDialog() {
				this.createWorkOrderDialog.visible = true
			},
			handleAddWorkOrderSuccess(res) {
