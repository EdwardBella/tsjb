...
<template>
  <el-dialog append-to-body title="案件取消受理" width="640px" :visible="visible" @close="handleClose">
    <el-form ref="form" :model="form" :rules="rules" label-suffix="：">
      <el-form-item label="取消受理备注" prop="comment">
        <el-input
...
import { cancelDistribute } from "@/api/workOrder/distribute";
