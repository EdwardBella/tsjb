<template>
	<div>
		<el-dialog append-to-body title="预审反馈" v-dialogDrags :visible.sync="visible" width="660px" :before-close="handleClose">
			<el-form :model="form" :rules="rules" label-position="right" ref="form" class="white-card"
				label-width="140px">
